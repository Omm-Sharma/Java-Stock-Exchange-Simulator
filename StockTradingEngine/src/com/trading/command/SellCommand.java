...
public class SellCommand implements Command {
    ...
    public SellCommand(MarketService marketService, OrderExecutor orderExecutor, Portfolio portfolio) {
    ...
    public void execute(String[] args) {
        if (args.length < 2) {
            System.out.println("Usage: sell <symbol> <quantity>");
            return;
        }
        ...
        try {
            ...
            if (stock != null) {
                orderExecutor.processSell(portfolio, stock, qty);
            } else {
